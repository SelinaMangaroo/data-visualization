...
def generate_report_section(input_path, options=None, **kwargs):
    ...
    for csv_file_path in csv_files:
        try:
            ...
            if drop_empty_columns:
                ...
                logger.info(f"Dropped empty columns from {csv_file_path}")

            # Column counts + zero check
            ...
            columns_with_zeros_html = (
                ...
                if columns_with_zeros_list else ""
            )
    ...
    return analysis_html + "<div class='page-break'></div>"
