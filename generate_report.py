...
def process_and_generate_report(report_configs=None, general_options=None):
    ...
    for config in report_configs:
        ...
        try:
            ...
            print(f"[ERROR] Report module '{report_type}' not found.")
        except AttributeError:
            print(f"[ERROR] '{report_type}' module missing 'generate_report_section'.")
        except Exception as e:
            print(f"[ERROR] Failed to generate section '{report_type}': {e}")
